...
class MyFrame(wx.Frame):
    def __init__(self):
        super().__init__(
            None, title="Mself.ax16675 Baking temperature GUI plotter", size=(800, 800)
        )
        ...
        # box_sizer.Add(self.panel, 1, wx.EXPAND | wx.ALL, 5)
    ...
    def on_generate_plot(self, event):
        ...
        # self.ax2.set_title('Temperature Readings from Max16675 Sensors')
        def update_plot():
            try:
                # while True:
